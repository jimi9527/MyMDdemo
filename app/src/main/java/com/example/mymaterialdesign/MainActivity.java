...
import com.example.mymaterialdesign.view.MainFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    private void initFragment() {
        ...
        if(null == mCurrentFragment){
         ...
         fragmentTransaction.add(R.id.fragment,mCurrentFragment).commit();
        }
    }
    ...
    public void switchFragment(Class<?> clazz ){
        ...
        if(fragment.isAdded()){
            ...
            fragmentManager.beginTransaction().hide(mCurrentFragment).add(R.id.fragment, fragment).commitAllowingStateLoss();
        }
    }
}
